...
Summary(pl): GIMP - pisaki, gradienty, palety i wype軟ienia
...
%description -l pl
Pakiet ten zawiera archiwum dodatkowych plik闚 danych dla programu Gimp.

Zawiera on pisaki, gradienty, palety i wype軟ienia r騜nych autor闚.
